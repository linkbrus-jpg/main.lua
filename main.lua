...
local waypoints = {
    ...
    {pos = Vector3.new(-832.1, 480.7, 2117.0), action = "Run"},
    {pos = Vector3.new(-851.1, 489.1, 2091.2), action = "Run"},
    {pos = Vector3.new(-835.4, 489.2, 2080.6), action = "Run"},
    {pos = Vector3.new(-724.1, 533.6, 2194.0), action = "Jump"},
    {pos = Vector3.new(-701.7, 537.0, 2209.5), action = "Jump"},
    {pos = Vector3.new(-692.3, 543.7, 2234.0), action = "Jump"},
    {pos = Vector3.new(-667.2, 550.8, 2234.9), action = "Jump"},
    {pos = Vector3.new(-648.3, 557.9, 2247.2), action = "Jump"},
    {pos = Vector3.new(-639.6, 564.5, 2272.8), action = "Jump"},
    {pos = Vector3.new(-611.4, 571.7, 2270.5), action = "Jump"},
    {pos = Vector3.new(-593.7, 578.8, 2285.2), action = "Jump"},
    {pos = Vector3.new(-569.1, 585.4, 2285.3), action = "Jump"},
    {pos = Vector3.new(-560.5, 592.5, 2311.0), action = "Jump"},
    {pos = Vector3.new(-542.1, 599.6, 2322.9), action = "Jump"},
    {pos = Vector3.new(-516.7, 606.3, 2322.8), action = "Jump"},
    {pos = Vector3.new(-506.9, 613.4, 2348.2), action = "Jump"},
    {pos = Vector3.new(-488.2, 620.5, 2361.4), action = "Jump"},
    {pos = Vector3.new(-463.7, 627.1, 2363.0), action = "Jump"},
    {pos = Vector3.new(-456.8, 634.2, 2386.4), action = "Jump"},
    {pos = Vector3.new(-441.9, 636.4, 2398.8), action = "Run"},
    {pos = Vector3.new(-416.9, 639.9, 2415.4), action = "Run"},
    {pos = Vector3.new(-381.0, 636.8, 2416.2), action = "Jump"},
    {pos = Vector3.new(-363.7, 625.8, 2416.0), action = "Run"},
    {pos = Vector3.new(-341.9, 635.2, 2417.5), action = "Jump"},
    {pos = Vector3.new(-322.0, 625.5, 2416.0), action = "Run"},
    {pos = Vector3.new(-298.6, 635.7, 2417.7), action = "Jump"},
    {pos = Vector3.new(-278.4, 626.4, 2416.8), action = "Run"},
    {pos = Vector3.new(-258.4, 635.0, 2417.0), action = "Jump"},
    {pos = Vector3.new(-242.1, 640.8, 2420.1), action = "Run"},
    {pos = Vector3.new(-222.7, 642.0, 2422.4), action = "Run"},
    {pos = Vector3.new(-204.5, 690.0, 2564.6), action = "Run"},
    {pos = Vector3.new(-245.5, 690.6, 2573.5), action = "Jump"},
    {pos = Vector3.new(-266.9, 691.1, 2577.5), action = "Run"},
    {pos = Vector3.new(-290.0, 691.7, 2581.3), action = "Jump"},
    {pos = Vector3.new(-312.2, 692.2, 2584.7), action = "Run"},
    {pos = Vector3.new(-335.6, 692.8, 2589.8), action = "Jump"},
    {pos = Vector3.new(-359.2, 693.4, 2592.9), action = "Run"},
    {pos = Vector3.new(-394.1, 698.0, 2597.1), action = "Run"},
    {pos = Vector3.new(-421.7, 706.9, 2575.3), action = "Jump"},
    {pos = Vector3.new(-438.4, 715.6, 2564.6), action = "Run"},
    {pos = Vector3.new(-469.7, 730.0, 2534.1), action = "Run"},
    {pos = Vector3.new(-425.2, 728.8, 2513.2), action = "Jump"},
    {pos = Vector3.new(-403.5, 720.3, 2504.9), action = "Run"},
    {pos = Vector3.new(-384.3, 729.1, 2498.0), action = "Jump"},
    {pos = Vector3.new(-359.1, 722.6, 2487.6), action = "Run"},
    {pos = Vector3.new(-344.3, 729.2, 2483.1), action = "Jump"},
    {pos = Vector3.new(-321.1, 722.6, 2471.9), action = "Run"},
    {pos = Vector3.new(-308.1, 732.9, 2467.5), action = "Run"},
    {pos = Vector3.new(-280.0, 737.8, 2498.1), action = "Jump"},
    {pos = Vector3.new(-289.2, 743.6, 2515.7), action = "Jump"},
    {pos = Vector3.new(-272.0, 752.8, 2538.0), action = "Jump"},
    {pos = Vector3.new(-276.2, 763.9, 2569.1), action = "Run"},
    {pos = Vector3.new(-267.4, 770.0, 2595.4), action = "Run"},
    {pos = Vector3.new(-273.0, 769.2, 2604.2), action = "Run"},
    {pos = Vector3.new(-294.1, 765.6, 2631.2), action = "Jump"},
    {pos = Vector3.new(-317.9, 764.9, 2672.1), action = "Jump"},
    {pos = Vector3.new(-349.7, 765.5, 2703.8), action = "Jump"},
    {pos = Vector3.new(-387.9, 765.6, 2721.3), action = "Run"},
    {pos = Vector3.new(-434.9, 768.9, 2765.4), action = "Run"},
    {pos = Vector3.new(-587.1, 766.0, 2909.8), action = "Jump"},
    {pos = Vector3.new(-611.1, 773.3, 2884.2), action = "Jump"},
    {pos = Vector3.new(-639.2, 780.2, 2908.8), action = "Jump"},
    {pos = Vector3.new(-660.8, 787.1, 2928.0), action = "Jump"},
    {pos = Vector3.new(-635.4, 787.1, 2956.2), action = "Jump"},
    {pos = Vector3.new(-666.0, 787.1, 2981.6), action = "Jump"},
    {pos = Vector3.new(-667.6, 792.8, 3018.1), action = "Run"},
    {pos = Vector3.new(-729.4, 792.8, 3007.9), action = "Run"},
    {pos = Vector3.new(-744.7, 799.0, 3021.8), action = "Run"},
    {pos = Vector3.new(-743.6, 799.0, 3077.9), action = "Run"},
    {pos = Vector3.new(-750.0, 799.0, 3091.5), action = "Jump"},
    {pos = Vector3.new(-772.7, 804.2, 3110.9), action = "Run"},
    {pos = Vector3.new(-836.2, 804.2, 3100.3), action = "Run"},
    {pos = Vector3.new(-851.3, 810.4, 3113.5), action = "Run"},
    {pos = Vector3.new(-846.4, 810.4, 3170.6), action = "Run"},
    {pos = Vector3.new(-853.7, 810.4, 3182.4), action = "Jump"},
    {pos = Vector3.new(-874.0, 811.4, 3201.0), action = "Run"},
    {pos = Vector3.new(-937.3, 811.4, 3191.6), action = "Run"},
    {pos = Vector3.new(-975.5, 808.7, 3228.8), action = "Run"},
    {pos = Vector3.new(-986.4, 808.6, 3237.3), action = "Jump"},
    {pos = Vector3.new(-962.0, 808.6, 3263.1), action = "Run"},
    {pos = Vector3.new(-1010.7, 794.8, 3305.4), action = "Jump"},
    {pos = Vector3.new(-1035.4, 787.9, 3281.8), action = "Run"},
    {pos = Vector3.new(-1130.5, 807.3, 3373.3), action = "Run"},
    {pos = Vector3.new(-1168.1, 805.6, 3403.9), action = "Run"},
    {pos = Vector3.new(-1232.6, 784.4, 3440.0), action = "Jump"},
    {pos = Vector3.new(-1268.5, 777.9, 3458.4), action = "Run"},
    {pos = Vector3.new(-1358.3, 759.2, 3512.4), action = "Jump"},
    {pos = Vector3.new(-1367.5, 762.3, 3519.2), action = "Run"},
    {pos = Vector3.new(-1367.5, 762.3, 3564.8), action = "Run"},
    {pos = Vector3.new(-1372.0, 760.1, 3602.5), action = "Jump"},
    {pos = Vector3.new(-1363.0, 768.1, 3622.3), action = "Jump"},
    {pos = Vector3.new(-1379.7, 776.3, 3604.2), action = "Jump"},
    {pos = Vector3.new(-1361.4, 784.3, 3622.0), action = "Jump"},
    {pos = Vector3.new(-1384.5, 792.4, 3609.5), action = "Jump"},
    {pos = Vector3.new(-1364.0, 800.3, 3621.6), action = "Jump"},
    {pos = Vector3.new(-1385.5, 808.4, 3612.1), action = "Jump"},
    {pos = Vector3.new(-1370.8, 816.3, 3626.0), action = "Jump"},
    {pos = Vector3.new(-1387.3, 824.4, 3615.0), action = "Jump"},
    {pos = Vector3.new(-1379.9, 832.3, 3634.7), action = "Jump"},
    {pos = Vector3.new(-1393.9, 840.4, 3621.6), action = "Run"},
    {pos = Vector3.new(-1408.4, 840.4, 3632.9), action = "Jump"},
    {pos = Vector3.new(-1415.2, 844.8, 3642.0), action = "Run"},
    {pos = Vector3.new(-1458.5, 844.8, 3697.7), action = "Run"},
    {pos = Vector3.new(-1518.0, 837.0, 3751.9), action = "Run"},
    {pos = Vector3.new(-1536.8, 834.1, 3752.3), action = "Jump"},
    {pos = Vector3.new(-1547.3, 811.2, 3744.3), action = "Run"},
    {pos = Vector3.new(-1607.5, 784.1, 3731.8), action = "Jump"},
    {pos = Vector3.new(-1629.7, 787.6, 3732.7), action = "Run"},
    {pos = Vector3.new(-1645.6, 792.2, 3737.5), action = "Jump"},
    {pos = Vector3.new(-1666.1, 801.1, 3744.7), action = "Run"},
    {pos = Vector3.new(-1694.3, 844.3, 3786.0), action = "Jump"},
    {pos = Vector3.new(-1693.7, 856.5, 3801.9), action = "Run"},
    {pos = Vector3.new(-1723.4, 856.5, 3830.9), action = "Jump"},
    {pos = Vector3.new(-1744.1, 858.8, 3843.0), action = "Run"},
    {pos = Vector3.new(-1752.6, 869.7, 3829.5), action = "Run"},
    {pos = Vector3.new(-1752.4, 878.9, 3814.4), action = "Run"},
    {pos = Vector3.new(-1746.8, 884.3, 3800.2), action = "Run"},
    {pos = Vector3.new(-1739.1, 889.6, 3785.5), action = "Run"},
    {pos = Vector3.new(-1724.7, 890.0, 3777.3), action = "Run"},
    {pos = Vector3.new(-1706.8, 891.3, 3775.3), action = "Run"},
    {pos = Vector3.new(-1690.6, 893.1, 3783.2), action = "Run"},
    {pos = Vector3.new(-1685.3, 892.8, 3799.7), action = "Run"},
    {pos = Vector3.new(-1687.3, 895.2, 3815.9), action = "Run"},
    {pos = Vector3.new(-1698.6, 899.6, 3830.2), action = "Run"},
    {pos = Vector3.new(-1715.2, 902.1, 3832.1), action = "Run"},
    {pos = Vector3.new(-1730.6, 905.6, 3825.1), action = "Run"},
    {pos = Vector3.new(-1740.7, 910.2, 3810.8), action = "Run"},
    {pos = Vector3.new(-1738.6, 911.1, 3795.3), action = "Run"},
    {pos = Vector3.new(-1730.3, 912.8, 3782.3), action = "Run"},
    {pos = Vector3.new(-1713.3, 913.8, 3775.4), action = "Run"},
    {pos = Vector3.new(-1697.0, 914.6, 3779.1), action = "Run"},
    {pos = Vector3.new(-1685.2, 915.4, 3792.9), action = "Run"},
    {pos = Vector3.new(-1682.1, 917.7, 3808.0), action = "Run"},
    {pos = Vector3.new(-1691.3, 920.1, 3824.4), action = "Run"},
    {pos = Vector3.new(-1704.6, 923.9, 3832.4), action = "Run"},
    {pos = Vector3.new(-1719.7, 926.1, 3829.8), action = "Run"},
    {pos = Vector3.new(-1734.0, 930.3, 3818.1), action = "Run"},
    {pos = Vector3.new(-1740.1, 934.6, 3805.4), action = "Run"},
    {pos = Vector3.new(-1736.0, 935.0, 3791.2), action = "Run"},
    {pos = Vector3.new(-1727.0, 935.8, 3781.7), action = "Run"},
    {pos = Vector3.new(-1712.1, 937.3, 3777.0), action = "Run"},
    {pos = Vector3.new(-1712.1, 933.3, 3792.3), action = "Run"},
    {pos = Vector3.new(-1711.2, 1038.0, 3798.8), action = "Run"},
    {pos = Vector3.new(-1710.6, 1038.1, 3809.9), action = "Run"},
    {pos = Vector3.new(-1758.4, 1035.0, 3833.4), action = "Run"},
    {pos = Vector3.new(-1757.0, 1039.5, 3986.9), action = "Run"},
    {pos = Vector3.new(-1789.2, 1038.4, 4014.5), action = "Jump"},
    {pos = Vector3.new(-1827.1, 1027.0, 4052.0), action = "Jump"},
    {pos = Vector3.new(-1863.4, 1020.7, 4086.9), action = "Jump"},
    {pos = Vector3.new(-1903.5, 1015.8, 4126.5), action = "Jump"},
    {pos = Vector3.new(-1938.0, 1010.4, 4159.9), action = "Jump"},
    {pos = Vector3.new(-1978.6, 1005.5, 4196.8), action = "Run"},
    {pos = Vector3.new(-2039.6, 1000.5, 4262.0), action = "Run"},
    {pos = Vector3.new(-2029.9, 1000.5, 4270.9), action = "Run"},
    {pos = Vector3.new(-2051.8, 1009.7, 4291.3), action = "Run"},
    {pos = Vector3.new(-2071.0, 1009.6, 4270.0), action = "Run"},
    {pos = Vector3.new(-2093.5, 1018.8, 4292.7), action = "Run"},
    {pos = Vector3.new(-2070.1, 1018.8, 4314.2), action = "Run"},
    {pos = Vector3.new(-2096.5, 1028.0, 4331.4), action = "Run"},
    {pos = Vector3.new(-2108.5, 1028.0, 4321.0), action = "Run"},
    {pos = Vector3.new(-2184.4, 1038.4, 4392.5), action = "Run"},
    {pos = Vector3.new(-2173.4, 1041.2, 4404.0), action = "Run"},
    {pos = Vector3.new(-2197.3, 1045.7, 4422.7), action = "Run"},
    {pos = Vector3.new(-2213.6, 1050.1, 4403.7), action = "Run"},
    {pos = Vector3.new(-2237.1, 1054.3, 4426.4), action = "Run"},
    {pos = Vector3.new(-2215.4, 1059.4, 4445.7), action = "Run"},
    {pos = Vector3.new(-2240.0, 1064.2, 4465.4), action = "Run"},
    {pos = Vector3.new(-2255.5, 1068.3, 4448.1), action = "Run"},
    {pos = Vector3.new(-2277.8, 1073.2, 4471.0), action = "Run"},
    {pos = Vector3.new(-2258.1, 1078.1, 4490.4), action = "Run"},
    {pos = Vector3.new(-2278.6, 1082.9, 4511.2), action = "Run"},
    {pos = Vector3.new(-2299.4, 1087.1, 4489.9), action = "Run"},
    {pos = Vector3.new(-2322.4, 1090.8, 4512.2), action = "Run"},
    {pos = Vector3.new(-2300.4, 1095.9, 4530.6), action = "Run"},
    {pos = Vector3.new(-2322.1, 1100.3, 4554.5), action = "Run"},
    {pos = Vector3.new(-2342.7, 1105.6, 4532.7), action = "Run"},
    {pos = Vector3.new(-2366.6, 1107.5, 4553.0), action = "Run"},
    {pos = Vector3.new(-2344.2, 1112.9, 4573.2), action = "Run"},
    {pos = Vector3.new(-2365.6, 1116.3, 4595.3), action = "Run"},
    {pos = Vector3.new(-2385.8, 1121.7, 4573.6), action = "Run"},
    {pos = Vector3.new(-2408.3, 1126.0, 4596.7), action = "Run"},
    {pos = Vector3.new(-2386.8, 1131.2, 4616.3), action = "Run"},
    {pos = Vector3.new(-2408.6, 1134.9, 4637.6), action = "Run"},
    {pos = Vector3.new(-2428.2, 1140.1, 4616.5), action = "Run"},
    {pos = Vector3.new(-2450.6, 1144.4, 4638.4), action = "Run"},
    {pos = Vector3.new(-2429.1, 1149.5, 4657.9), action = "Run"},
    {pos = Vector3.new(-2450.5, 1153.4, 4680.4), action = "Run"},
    {pos = Vector3.new(-2472.4, 1158.8, 4658.8), action = "Run"},
    {pos = Vector3.new(-2492.3, 1162.6, 4681.3), action = "Run"},
    {pos = Vector3.new(-2471.6, 1167.6, 4700.2), action = "Run"},
    {pos = Vector3.new(-2494.1, 1172.0, 4722.7), action = "Jump"},
    {pos = Vector3.new(-2504.4, 1181.4, 4729.6), action = "Run"},
    {pos = Vector3.new(-2546.0, 1182.0, 4766.5), action = "Run"},
    {pos = Vector3.new(-2719.0, 1216.5, 4937.6), action = "Run"},
    {pos = Vector3.new(-2886.9, 1216.4, 5106.5), action = "Jump"},
    {pos = Vector3.new(-2948.7, 1251.7, 5045.8), action = "Run"},
    {pos = Vector3.new(-2963.3, 1251.7, 5058.8), action = "Run"},
    {pos = Vector3.new(-2901.8, 1279.1, 5117.8), action = "Run"},
    {pos = Vector3.new(-3056.0, 1220.0, 5266.0), action = "Run"},
    {pos = Vector3.new(-3204.1, 1221.5, 5415.8), action = "Run"},
    {pos = Vector3.new(-3235.8, 1219.2, 5447.6), action = "Jump"},
    {pos = Vector3.new(-3261.8, 1220.5, 5477.4), action = "Jump"},
    {pos = Vector3.new(-3309.5, 1220.5, 5495.1), action = "Jump"},
    {pos = Vector3.new(-3326.1, 1220.5, 5543.4), action = "Jump"},
    {pos = Vector3.new(-3370.3, 1220.5, 5559.8), action = "Jump"},
    {pos = Vector3.new(-3389.0, 1220.5, 5607.9), action = "Jump"},
    {pos = Vector3.new(-3436.0, 1220.5, 5623.1), action = "Jump"},
}
