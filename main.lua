...
-- LOAD UI HUB
-- ====================================================================
local QrinzUI = loadstring(game:HttpGet("https://raw.githubusercontent.com/Qrin-Dev/UI/refs/heads/main/source.lua"))()
...
Vector3.new(-5287.1, 467.8, 1468.0),
                Vector3.new(-5336.2, 469.2, 1475.3),
        Vector3.new(-5377.5, 474.0, 1476.1),
Vector3.new(-5406.4, 474.0, 1476.2),
{pos = Vector3.new(-5635.3, 477.4, 1324.1), action = "jump"},
Vector3.new(-5635.3, 477.4, 1324.1),
        Vector3.new(-5686.1, 479.2, 1357.0), 
        {pos = Vector3.new(-5868.0, 480.4, 1576.2), action = "jump"}, 
        Vector3.new(-5868.0, 480.4, 1576.2), 
        Vector3.new(-5911.0, 483.7, 1570.7), 
        {pos = Vector3.new(-6168.4, 480.2, 1420.7), action = "jump"}, 
        Vector3.new(-6168.4, 480.2, 1420.7),
        Vector3.new(-6202.1, 479.6, 1456.8),
                {pos = Vector3.new(-6453.9, 478.9, 1385.6), action = "jump"}, 
        Vector3.new(-6453.9, 478.9, 1385.6),
        Vector3.new(-6509.9, 482.4, 1376.0),
                {pos = Vector3.new(-6783.0, 520.2, 1489.4), action = "jump"}, 
        Vector3.new(-6783.0, 520.2, 1489.4),
        Vector3.new(-6806.6, 520.2, 1486.3),
        Vector3.new(-6807.9, 520.6, 1470.1),
    }
...
local Window = QrinzUI:CreateWindow({
    Title = "Qrinz Test Hub",
    Author = "Versi Evaluasi v1.0",
    })


local TabUtama = Window:Tab({ Title = "Fitur Utama" })

TabUtama:Dropdown({
    Title = "Select Target Monster",
    Values = { "Pilihan 1", "Pilihan 2", "Pilihan 3", "Pilihan 4", "Pilihan 5", "Pilihan 6", "Pilihan 7", "Pilihan 8", "Pilihan 9", "Pilihan 10", "Pilihan 11", "Pilihan 12", "Pilihan 13"},
    Value = "Pilihan 1",
...
TabUtama:Toggle({
    Title = "Fitur Auto Farm (Cek Console)",
    Value = false,
