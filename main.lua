...
local waypoints = {
    ...
    {pos = Vector3.new(-1761.4, 1036.3, 3968.7), action = "Run"},
    {pos = Vector3.new(-1731.8, 1034.3, 3958.9), action = "Jump"},
    {pos = Vector3.new(-1709.7, 1034.3, 3951.9), action = "Jump"},
    {pos = Vector3.new(-1690.3, 1041.3, 3937.3), action = "Jump"},
    {pos = Vector3.new(-1705.3, 1048.3, 3922.1), action = "Jump"},
    {pos = Vector3.new(-1722.1, 1055.3, 3936.7), action = "Jump"},
    {pos = Vector3.new(-1706.5, 1062.2, 3952.2), action = "Jump"},
    {pos = Vector3.new(-1692.0, 1069.2, 3936.9), action = "Jump"},
    {pos = Vector3.new(-1705.2, 1076.2, 3921.5), action = "Jump"},
    {pos = Vector3.new(-1720.3, 1083.1, 3935.7), action = "Jump"},
    {pos = Vector3.new(-1707.2, 1090.1, 3951.9), action = "Jump"},
    {pos = Vector3.new(-1691.4, 1097.0, 3937.2), action = "Jump"},
    {pos = Vector3.new(-1705.9, 1104.0, 3921.3), action = "Jump"},
    {pos = Vector3.new(-1722.1, 1111.0, 3933.6), action = "Jump"},
    {pos = Vector3.new(-1704.9, 1117.9, 3950.8), action = "Jump"},
    {pos = Vector3.new(-1691.5, 1124.9, 3936.6), action = "Jump"},
    {pos = Vector3.new(-1706.4, 1131.9, 3921.3), action = "Jump"},
    {pos = Vector3.new(-1722.4, 1138.9, 3935.2), action = "Jump"},
    {pos = Vector3.new(-1704.4, 1145.8, 3950.7), action = "Jump"},
    {pos = Vector3.new(-1690.5, 1152.8, 3939.9), action = "Jump"},
    {pos = Vector3.new(-1707.2, 1159.7, 3921.0), action = "Jump"},
    {pos = Vector3.new(-1721.8, 1166.7, 3936.6), action = "Jump"},
    {pos = Vector3.new(-1706.9, 1173.6, 3952.6), action = "Jump"},
    {pos = Vector3.new(-1691.6, 1180.6, 3936.2), action = "Jump"},
    {pos = Vector3.new(-1700.0, 1187.7, 3921.8), action = "Run"},
    {pos = Vector3.new(-1711.5, 1187.7, 3921.2), action = "Run"},
    {pos = Vector3.new(-1745.7, 1223.6, 3952.7), action = "Jump"},
    {pos = Vector3.new(-1753.5, 1226.5, 3958.8), action = "Run"},
    {pos = Vector3.new(-1752.0, 1226.5, 3966.9), action = "Run"},
    {pos = Vector3.new(-1795.7, 1250.0, 4004.1), action = "Jump"},
}
